-- =====================================================
-- NUKE ALL WITH CASCADE
-- Completely removes all problematic database objects with dependencies
-- =====================================================
...
DO $$
BEGIN
    RAISE NOTICE '✅ NUKE WITH CASCADE COMPLETED!';
    RAISE NOTICE '✅ All triggers and functions dropped with CASCADE';
    RAISE NOTICE '✅ All dependencies removed';
