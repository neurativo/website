-- =====================================================
-- NEURATIVO DATABASE SETUP - CLEAN VERSION
...
-- =====================================================
-- 1. CLEAN UP EXISTING OBJECTS (if they exist)
-- =====================================================
...
BEGIN
    ...
    -- Drop policies for user_subscriptions table
    DROP POLICY IF EXISTS "Users can view own subscriptions" ON public.user_subscriptions;
    DROP POLICY IF EXISTS "Users can update own subscriptions" ON public.user_subscriptions;
    DROP POLICY IF EXISTS "Users can insert own subscriptions" ON public.user_subscriptions;
    
    -- Drop policies for usage_stats table
    ...
    -- Drop policies for ai_usage_logs table
    ...
    RAISE NOTICE 'Cleaned up existing policies, triggers, and views';
END $$;
...
-- =====================================================
-- 7. INSERT DEFAULT PLANS (after tables are created)
-- =====================================================
...
-- =====================================================
-- 8. UPDATE EXISTING TABLES (if they exist)
-- =====================================================
...
BEGIN
    ...
    RAISE NOTICE 'All existing objects cleaned up and recreated';
END $$; 