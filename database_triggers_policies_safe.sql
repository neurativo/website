-- =====================================================
-- SAFE TRIGGERS AND POLICIES FOR NEURATIVO
...
DROP TRIGGER IF EXISTS update_quiz_stats_trigger ON public.quiz_questions;
...
DROP POLICY IF EXISTS "Anyone can view quiz categories" ON public.quiz_categories;
DROP POLICY IF EXISTS "Anyone can view subscription plans" ON public.subscription_plans;
DROP POLICY IF EXISTS "Only authenticated users can view admin settings" ON public.admin_settings;
...
-- =====================================================
-- SAFE TRIGGERS AND POLICIES COMPLETED
-- =====================================================

-- Success message
DO $$
BEGIN
    RAISE NOTICE 'Safe triggers and policies setup completed successfully!';
    RAISE NOTICE 'All existing triggers and policies dropped';
    RAISE NOTICE 'All triggers recreated for automatic updates';
    RAISE NOTICE 'All RLS policies recreated for security';
