-- =====================================================
-- SAFE DATABASE SETUP FOR NEURATIVO
-- Handles all dependencies safely without errors
-- =====================================================
...
-- =====================================================
-- 1. SAFE DROP POLICIES (only if tables exist)
-- =====================================================

-- Function to safely drop policies
CREATE OR REPLACE FUNCTION safe_drop_policies()
RETURNS void AS $$
BEGIN
    ...
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_game_stats') THEN
    ...
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'user_analytics') THEN
    ...
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'system_notifications') THEN
